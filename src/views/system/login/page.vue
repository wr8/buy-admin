          ...
          <div class="page-login--form">
            <el-card shadow="never">
              ...
              <el-form
                ...
                size="default"
              >
                <el-form-item prop="username" v-show='activeName == "密码登陆"'>
                  <el-input type="text" v-model="formLogin.username" placeholder="用户名">
                    <i slot="prepend" class="fa fa-user-circle-o"></i>
                  </el-input>
                </el-form-item>
                <el-form-item prop="password" v-show='activeName == "密码登陆"'>
                  <el-input type="password" v-model="formLogin.password" placeholder="密码">
                    <i slot="prepend" class="fa fa-keyboard-o"></i>
                  </el-input>
                </el-form-item>
                <el-form-item prop="phone" v-show='activeName == "验证码登陆"'>
                  <el-input type="phone" v-model="formLogin.password" placeholder="密码">
                    <i slot="prepend" class="fa fa-keyboard-o"></i>
                  </el-input>
                </el-form-item>
                <el-form-item prop="code" v-show='activeName == "验证码登陆"'>
                  <el-input type="code" v-model="formLogin.password" placeholder="密码">
                    <i slot="prepend" class="fa fa-keyboard-o"></i>
                  </el-input>
                </el-form-item>
